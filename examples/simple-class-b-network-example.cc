...
NS_LOG_COMPONENT_DEFINE ("SimpleClassBLorawanNetworkExample");

int main (int argc, char *argv[])
{

  // Set up logging
  LogComponentEnable ("SimpleClassBLorawanNetworkExample", LOG_LEVEL_ALL);
  ...
  ************************/
  ...
  // Create and add the devices to the multicast group
  //LoraDeviceAddress mcGroup1 =  macHelper.CreateMulticastGroup (endDevices);
  ...
  *********************/
  ...
  macHelper.EnableBeaconTransmission (gateways);
  
  //Enable the class B downlink
  macHelper.EnableClassBDownlinkTransmission (gateways);
